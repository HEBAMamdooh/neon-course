...
<head>
  ...
  <![endif]-->
  <script src="backend/plugins/nprogress/nprogress.js"></script>
</head>
...
<body class="bg-light-gray" id="body">
  <div class="container d-flex flex-column justify-content-between vh-100">
          ...
          <div class="card-header bg-primary">
            <div class="app-brand">
              <a href="/index.html">
                ...
                <span class="brand-name">WIND Dashboard</span>
              </a>
            </div>
          </div>
            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="row">
                <div class="form-group col-md-12 mb-4">
                  <input type="email" class="form-control input-lg" name="email" id="email" placeholder="Username">
                </div>
    ...
    <div class="copyright pl-0">
      <p class="text-center">&copy; {{ date("y") }} Copyright WIND Dashboard by
